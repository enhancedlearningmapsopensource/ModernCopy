...
<html>
    <head>
        ...
        <!-- STYLE SHEETS -->
        <link rel="stylesheet" href="./group-manager/main.css"/>
        <link rel="stylesheet" href="./group-manager/lib/io/css/main.css"/>
    ...
    <body>
        <?php WriteTemplate("./group-manager/templates/page.html", "page-template") ?>
        <?php WriteTemplate("./group-manager/templates/category.html", "category-template") ?>
        <?php WriteTemplate("./group-manager/templates/table.html", "table-template") ?>
        <?php WriteTemplate("./group-manager/templates/edit-user-group.html", "edit-user-group") ?>
        <?php WriteTemplate("./group-manager/templates/new-permission.html", "new-permission") ?>
        <?php WriteTemplate("./group-manager/templates/edit-string.html", "edit-string") ?>
        <?php WriteTemplate("./group-manager/templates/delete-confirm.html", "delete-confirm") ?>
        ...
        <script src='./group-manager/velocity-class.js'></script>
        <script>
            var gRoot = '<?= ELM_ROOT ?>';
        ...
        <script data-main='./group-manager/require-config-group-manager.js' src='<?= ELM_ROOT ?>external-lib/require/debug/v2.2.0/requirejs.js'></script>
        <script>
